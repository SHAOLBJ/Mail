...
public class SendMail {
	...
	public static void main(String[] args) {
		...
		sendmail.setUserName("359062566@qq.com");// 您的邮箱用户名
		sendmail.setPassWord("pjyfehkusfpnbhef");// 您的邮箱密码
		sendmail.setTo("1677690850@qq.com");// 接收者
		sendmail.setFrom("359062566@qq.com");// 发送者
